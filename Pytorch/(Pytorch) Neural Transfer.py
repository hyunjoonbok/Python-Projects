...
style_img = image_loader("./data/images/gogh.jpg")
content_img = image_loader("./data/images/mako.jpeg")
...
# Use VGG19
# Two child Sequential modules: features (containing convolution and pooling layers), and classifier (containing fully connected layers)
